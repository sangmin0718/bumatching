...
const CITIES = {
  ...
  "충청북도": [
    ...
    "제천시","증평군","진천군","청원구","청주시 상당구",
    "청주시 서원구","청주시 흥덕구","충주시"
  ],
  "전라북도": [
    "고창군","군산시","김제시","남원시","무주군","부안군",
    "순창군","완주군","익산시","임실군","장수군","전주시 덕진구","전주시 완산구",
    "정읍시","진안군"
  ],
  "전라남도": [
...
const HOBBIES = [
  "헬스","러닝","수영","요가","필라테스","등산","클라이밍","축구","농구","야구",
      "게임","보드게임","퍼즐","코딩","경기 관람",
      "영화","넷플릭스","드라마","예능","애니","다큐","공포영화","독립영화",
      "K-POP", "J-POP","노래","밴드","악기","피아노","기타","드럼",
      "독서","시집","그림그리기","소설","경제","자기계발", "경영", 
      "요리","베이킹","커피","카페탐방","차(티)","와인","맥주","맛집탐방",
      "사진","필름카메라","여행","드라이브","캠핑","백패킹","차박","낚시",
      "전시회","뮤지컬","연극","미술관","유튜브","콘서트",
      "댄스","방탈출","노래방","춤","클럽","파티",
      "패션","뷰티","메이크업","쇼핑","악세사리",
